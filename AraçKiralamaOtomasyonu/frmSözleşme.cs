...
namespace AraçKiralamaOtomasyonu
{
    public partial class frmSözleşme : Form
    {
        ...
        private void Yenile()
        {
            ...
            dataGridView1.DataSource = arac.listele(adtr2, sorgu3);//listele hata verice üstteki iki satırı yazdık. ve Yenile metotunu oluşturduk.
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            komut2.Parameters.AddWithValue("@e_tarih", lblE_Tarih.Text);
            komut2.Parameters.AddWithValue("@e_yer", lblE_Yer.Text);
        ...
        private void btnAraçTeslim_Click(object sender, EventArgs e)
        {
            if (txtEkstra.Text!="") 
            {
                ...
                //Toplamtutar,_gun ve ucret satış tablosuna aktaracak
